...
class ManageUsersController extends Controller {
    ...
    public function detail( $id ) {
        ...
        return view( 'admin.users.detail', compact( 'pageTitle', 'user', 'totalDeposit', 'totalWithdrawals', 'totalTransaction', 'totalBets', 'totalReferredUsers', 'totalReferralCom', 'countries', 'betWinAmount' ) );
    }
    ...
    public function referralCommissions( $id ) {
        ...
        $logs      = CommissionLog::where( 'to_id', $user->id )->with( [
            'byWho',
            'toUser'
