...
// File: app/Services/Leagues/NHL_Helper.php
        ...
        if ($this->apiProvider == 'sportsradar') {
            ...
            foreach ($games as $game) {
                ...
                $values = [
                    ...
                    'time_zones_venue' => $game['venue']['time_zone'] ?? null,
                    'time_zones_home' => $game['home']['time_zone'] ?? null,
                    'time_zones_away' => $game['away']['time_zone'] ?? null,
                ];
        ...
        if ($this->apiProvider == 'sportsradar') {
            ...
            foreach ($players as $player) {
                ...
                try {
                    ...
                    Log::error('Error updating player game logs for league: ' . $this->league->name . ' with ' . $this->apiProvider);
        ...
        if ($this->apiProvider == 'sportsradar') {
            ...
            foreach ($players as $player) {
                ...
                $values = [
                    ...
                    "sr_id" => $player['sr_id'] ?? null,
                    'reference' => $player['reference'] ?? null,
                    'total' => json_encode($player['statistics']['total']) ?? null,
                    'average' => json_encode($player['statistics']['average']) ?? null,
                ];
