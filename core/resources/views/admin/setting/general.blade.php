...
{{--                                    <div class="input-group">--}}
{{--                                        <input class="form-control" name="single_bet_min_limit" type="number" value="{{ getAmount($general->single_bet_min_limit) }}" step="any" min="0" required>--}}
...
{{--                            <div class="col-md-4 col-sm-6">--}}
{{--                                <div class="form-group">--}}
{{--                                    <label>@lang('Single Bet Maximum Limit')</label>--}}
{{--                                    <div class="input-group">--}}
{{--                                        <input class="form-control" name="single_bet_max_limit" type="number" value="{{ getAmount($general->single_bet_max_limit) }}" step="any" min="0" required>--}}
{{--                                        <span class="input-group-text">{{ $general->cur_text }}</span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Multi Bet Minimum Limit')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="multi_bet_min_limit" type="number" value="{{ getAmount($general->multi_bet_min_limit) }}" step="any" min="0" required>
                                        <span class="input-group-text">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Multi Bet Maximum Limit')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="multi_bet_max_limit" type="number" value="{{ getAmount($general->multi_bet_max_limit) }}" step="any" min="0" required>
                                        <span class="input-group-text">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                            </div>
