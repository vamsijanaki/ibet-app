                ...
                <div class="card-body">
                    ...
                    @if ($user->kv == 2)
                        <div class="d-flex justify-content-end mt-3 flex-wrap gap-3">
                            <button class="btn btn-outline--danger confirmationBtn" data-question="@lang('Are you sure to reject this documents?')" data-action="{{ route('admin.users.kyc.reject', $user->id) }}"><i class="las la-ban"></i>@lang('Reject')</button>
