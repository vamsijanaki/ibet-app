    ...
    <nav class="sports-category" data-simplebar style="display:none">
    ...
    <nav class="sports-sub-category" data-simplebar style="display:none">
        <div class="sports-category__list">
    ...
    <div class="sub-category-drawer" style="display:none">
