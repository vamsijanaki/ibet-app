                            ...
                            <div class="verification-area">
                                <form class="submit-form" action="{{ route('user.verify.email') }}" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <p class="text-muted">@lang('A 6 digit verification code sent to your email address') : {{ showEmailAddress(auth()->user()->email) }}</p>
                                    </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        @lang('If you don\'t receive any code'), <a href="{{ route('user.send.verify.code', 'email') }}">@lang('Try again')</a>
                                    </div>
