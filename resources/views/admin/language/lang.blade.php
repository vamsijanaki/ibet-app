...
@push('breadcrumb-plugins')
    <button class="btn btn-sm btn-outline--primary" data-bs-toggle="modal" data-bs-target="#createModal" type="button"><i class="las la-plus"></i>@lang('Add New')</button>
    <button class="btn btn-sm btn-outline--info keyBtn" data-bs-toggle="modal" data-bs-target="#getLangModal" type="button"><i class="las la-code"></i>@lang('Language Keywords')</button>
@endpush
