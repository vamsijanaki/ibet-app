        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" title="Balance" style="2" color="info" bg="white" icon="las la-money-bill-wave-alt" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalDeposit) }}" title="Deposited" style="2" color="success" bg="white" icon="las la-wallet" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalWithdrawals) }}" title="Withdrawan" style="2" color="warning" bg="white" icon="las la-wallet" link="{{ route('admin.withdraw.log') }}?search={{ $user->username }}" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ getAmount($totalTransaction) }}" title="Transactions" style="2" color="17" bg="white" icon="las la-exchange-alt" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ getAmount($totalBets) }}" title="Bet Placed" style="2" color="cyan" bg="white" icon="las la-gamepad" link="{{ route('admin.users.bets', $user->id) }}" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ getAmount($betWinAmount) }}" title="Returned Amount" style="2" color="green" bg="white" icon="las la-hand-holding-usd" link="{{ route('admin.users.bets', $user->id) }}?search=win" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $totalReferredUsers }}" title="Referred" style="2" color="deep-purple" bg="white" icon="las la-sitemap" link="{{ route('admin.users.refereed.users', $user->id) }}" overlay_icon=0 />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalReferralCom) }}" title="Ref. Commission Received" style="2" color="teal" bg="white" icon="las la-sitemap" link="{{ route('admin.users.referral.commissions', $user->id) }}" overlay_icon=0 />
                </div>
            </div>
