...
Route::middleware('admin')->group(function () {
    ...
    // Stats Manager
    Route::controller('StatsController')->name('stats.')->prefix('stats')->group(function () {
        Route::get('/{league}', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    Route::controller('GameController')->name('game.')->prefix('games')->group(function () {
        ...
        Route::post('schedules', 'schedulesByWeek')->name('schedules');
        Route::post('schedule-date', 'schedulesByDate')->name('scheduleDate');
        Route::post('schedule-game', 'scheduleGameById')->name('scheduleGame');
        Route::post('schedule-team', 'scheduleTeam')->name('scheduleTeam');
        Route::post('schedule-player', 'schedulePlayer')->name('schedulePlayer');
        ...
        Route::get('create_std', 'createStd')->name('create_std');
        Route::get('edit_std/{id}', 'editStd')->name('edit_std');
        Route::post('store_std/{id?}', 'storeStd')->name('store_std');
        Route::post('status_std/{id}', 'updateStatusStd')->name('status_std');
    });
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        //api settings
        Route::get('api-setting/{league}', 'apiSetting')->name('setting.api.index');
        Route::post('api-setting/{league}', 'apiUpdate')->name('setting.api.update');
    });
    ...
    Route::controller('ManagePlayersController')->name('player.')->prefix('players')->group(function () {
        Route::get('/{league}', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
    });
